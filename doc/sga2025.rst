...
and ``DDDD`` = |Dec| × 100 (four digits, zero-padded), both at a precision of
...
.. code-block:: none
   ...
   SGA2025-beta-v1.6-dr11-north.fits    (~130,000 galaxies)
...
detected within its ellipse. See the `legacypipe documentation
<https://legacypipe.readthedocs.io>`_ for the full Tractor data model.
