...
- ``OBJNAME`` (str30) — the common name from the input parent catalog
  (HyperLeda, NED, `LVD <https://local-volume-database.readthedocs.io/en/latest/index.html>`_, etc.).
...
`SDSS DR17 <https://www.sdss4.org/dr17/>`_, **NED**, and the
...
high-precision "gold-tier" measurements compiled by NED, the
`Local Volume Database (LVD) <https://local-volume-database.readthedocs.io/en/latest/index.html>`_,
