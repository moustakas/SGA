...
```
docker pull legacysurvey/legacypipe:DR11.0.0
...
```
docker buildx build --platform linux/amd64,linux/arm64/v8 --push -t legacysurvey/sga:1.8.0 .
...
Or at NERSC:
```
shifterimg pull docker:legacysurvey/sga:1.8.0
shifter --image docker:legacysurvey/sga:1.8.0 bash
```
