...
```
docker pull legacysurvey/legacypipe:main-gpu-1.6
...
```
docker buildx build --platform linux/amd64,linux/arm64/v8 --push -t legacysurvey/sga:1.6.0 .
...
Or at NERSC:
```
shifterimg pull docker:legacysurvey/sga:1.6.0
shifter --image docker:legacysurvey/sga:1.6.0 bash
```
