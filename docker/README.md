...
```
docker pull legacysurvey/legacypipe:DR10.9.0
...
```
docker buildx build --platform linux/amd64,linux/arm64/v8 --push -t legacysurvey/sga:1.7.0 .
...
Or at NERSC:
```
shifterimg pull docker:legacysurvey/sga:1.7.0
shifter --image docker:legacysurvey/sga:1.7.0 bash
```
