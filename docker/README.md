...
```
docker pull legacysurvey/legacypipe:gpu-1.7.1
...
```
docker buildx build --platform linux/amd64,linux/arm64/v8 --push -t legacysurvey/sga:1.0.1 .
...
Or at NERSC:
```
shifterimg pull docker:legacysurvey/sga:1.0.1
shifter --image docker:legacysurvey/sga:1.0.1 bash
```
