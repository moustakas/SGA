...
```
docker pull legacysurvey/legacypipe:gpu-1.4.14
...
```
docker buildx build --platform linux/amd64,linux/arm64/v8 --push -t legacysurvey/sga:0.6.0 .
...
Or at NERSC:
```
shifterimg pull docker:legacysurvey/sga:0.6.0
shifter --image docker:legacysurvey/sga:0.6.0 bash
```
