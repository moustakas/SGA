...
```
docker pull legacysurvey/legacypipe:gpu-mem-1.3
...
```
docker buildx build --platform linux/amd64,linux/arm64/v8 --push -t legacysurvey/sga:0.8.3 .
...
Or at NERSC:
```
shifterimg pull docker:legacysurvey/sga:0.8.3
shifter --image docker:legacysurvey/sga:0.8.3 bash
```
