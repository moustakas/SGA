...
```
docker pull legacysurvey/legacypipe:main-gpu-1.2
...
```
docker buildx build --platform linux/amd64,linux/arm64/v8 --push -t legacysurvey/sga:1.3.0 .
...
Or at NERSC:
```
shifterimg pull docker:legacysurvey/sga:1.3.0
shifter --image docker:legacysurvey/sga:1.3.0 bash
```
