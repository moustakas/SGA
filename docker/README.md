...
```
docker pull legacysurvey/cutouts:v1.4.2
...
```
docker buildx build --platform linux/amd64,linux/arm64/v8 --push -t legacysurvey/sga:0.5.2 .
...
Or at NERSC:
```
shifterimg pull docker:legacysurvey/sga:0.5.2
