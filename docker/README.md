...
```
docker pull legacysurvey/legacypipe:gpu-mem-1.2
...
```
docker buildx build --platform linux/amd64,linux/arm64/v8 --push -t legacysurvey/sga:0.8.2 .
...
Or at NERSC:
```
shifterimg pull docker:legacysurvey/sga:0.8.2
shifter --image docker:legacysurvey/sga:0.8.2 bash
```
