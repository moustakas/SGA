...
```
docker pull legacysurvey/legacypipe:gpu-mem-1.4
...
```
docker buildx build --platform linux/amd64,linux/arm64/v8 --push -t legacysurvey/sga:0.8.4 .
...
Or at NERSC:
```
shifterimg pull docker:legacysurvey/sga:0.8.4
shifter --image docker:legacysurvey/sga:0.8.4 bash
```
